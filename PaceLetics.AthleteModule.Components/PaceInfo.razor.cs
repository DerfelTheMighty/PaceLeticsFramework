...
Viele empfinden hier einen angenehmen Flow. Für reines Grundlagentraining ist sie aber viel zu schnell.";

        private string TText = @"Die T-Pace liegt nahe deinem 10-km-Tempo und verbindet hohe aerobe und anaerobe Anteile. 
Dieses Tempo kannst du ungefähr eine Stunde halten. Fortgeschrittene nutzen es für längere Intervalle, Einsteigende auch für kürzere Abschnitte.";
...
Sie verbessert Laufökonomie, Kraft und Koordination. Intervalle sind kurz, Pausen lang. Vor allem für erfahrene Läufer:innen geeignet.";
    }
}
