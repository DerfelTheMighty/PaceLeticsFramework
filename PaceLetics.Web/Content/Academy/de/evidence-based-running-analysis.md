...
title: Evidenzbasierte Laufanalyse
summary: Warum Laufanalyse Evidenz, Kontext und gemeinsame Entscheidungen braucht.
...
- Mittlere bis gute Evidenz, die ein positives Kosten-Nutzen-Verhältnis für zukünftige Verletzungen aufzeigt. [[1]](https://pubmed.ncbi.nlm.nih.gov/31028658/) [[2]](https://pubmed.ncbi.nlm.nih.gov/35247202/)
- Geringe bis mittlere Evidenz und das gleichzeitige Vorhandensein von Symptomen, die mit der Intervention assoziiert sind. [[6]](https://pmc.ncbi.nlm.nih.gov/articles/PMC9655004/)

Für die meisten gängigen Kriterien einer guten Lauftechnik sind diese Voraussetzungen nicht erfüllt.
...
- Ein Hinweis zum Laufstil ist keine Bewertung, ob du richtig oder falsch läufst.
- Deine eigene Wahrnehmung ist wichtig: Was spürst du, wann tritt es auf, was verändert es?
- Wir betrachten Laufstil immer im Kontext von Beschwerden, Training, Schuhwerk, Tempo, Umfang und Ermüdung.
- Du bekommst eine Einordnung und mögliche Optionen, keine Pflicht zur Formkorrektur.

## Wann ein Muster relevant wird

- Eine sichtbare Abweichung allein ist noch kein Problem. Viele Laufstile funktionieren sehr gut.
- Wichtiger wird ein Muster, wenn die Evidenz gut ist und es dynamisch im Laufen sichtbar wird. [[1]](https://pubmed.ncbi.nlm.nih.gov/31028658/) [[2]](https://pubmed.ncbi.nlm.nih.gov/35247202/)
- Bei mittlerer oder schwacher Evidenz zählt vor allem, ob passende Beschwerden, Ermüdung oder Kontrollverlust dazukommen. [[6]](https://pmc.ncbi.nlm.nih.gov/articles/PMC9655004/)
- Ohne Beschwerden oder plausible Belastungskopplung bleibt ein auffälliges Muster meistens individuelle Variation.

## Evidenzgrade und Nutzen für Verletzungsprophylaxe

| Merkmal | Evidenz | Score | Nutzen | Relevant, wenn |
|---|---:|---:|---|---|
| Hip Drop | B | 8 | Hoch | Dynamisch sichtbar und mit Symptomen gekoppelt |
| Bein-Innenrotation | B | 8 | Hoch | Dynamisch sichtbar und mit Symptomen gekoppelt |
| Overstride | C | 7 | Mittel | Mit Überlastung, Bremsimpuls oder Beschwerden gekoppelt |
| Vorneigung | C | 5 | Niedrig | Klar mit Beschwerden oder Leistungsziel verbunden |
| Hüftextension | D | 4 | Niedrig | Nur im Kontext von Beweglichkeit, Kraft und Symptomen |
| Lordose | D | 3 | Sehr niedrig | Nur bei klarer Beschwerdekopplung |
| Rumpfrotation | D | 3 | Sehr niedrig | Nur bei klarer Beschwerdekopplung |
| Armwinkel | D | 1 | Kein | Meist Rhythmus, Ökonomie oder Spannung statt Verletzungsrisiko |
