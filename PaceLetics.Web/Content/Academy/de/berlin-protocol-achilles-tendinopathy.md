...
| Mylle et al. [[4]](https://doi.org/10.1249/MSS.0000000000003606) | 12-wöchige exzentrische Rehabilitation | Einbeinige Fersenabsenkungen auf einer Stufe auf der betroffenen Seite; Ausführung mit gestrecktem Knie und mit gebeugtem Knie; je 3 x 15 Wdh., 2-mal täglich, 7 Tage/Woche. | VISA-A und funktionelle Tests verbesserten sich; Sehnensteifigkeit und Young’s Modulus stiegen, morphologische Eigenschaften wie Volumen und CSA änderten sich nicht signifikant. |
...
Bohm et al. kommen in ihrer systematischen Übersichtsarbeit zu dem Schluss, dass Sehnen auf 
mechanisches Training adaptieren können und dass vor allem die Höhe der Belastung beziehungsweise 
Sehnendehnung wichtig ist, weniger die reine Kontraktionsform [[6]](https://doi.org/10.1186/s40798-015-0009-9). 
Lazarczuk et al. bestätigen für gesunde untere Extremitätsehnen, dass mechanisches Training 
...
Wadenarbeit sinnvoll sein. Danach sollte die Belastung schrittweise in Richtung hoher, 
...
Wenn Symptome während der Einheit deutlich steigen oder am nächsten Tag nachhallen, 
war die Belastung für den aktuellen Anpassungsstand wahrscheinlich zu hoch [[15]](https://doi.org/10.2519/jospt.2015.5885).

## Praktischer Trainingsrahmen

Sehnentraining sollte über mindestens 12 Wochen geplant werden. Der Hauptreiz ist hohe, kontrollierte Zugspannung. 
Je nach Gesamtbelastung sind 2 bis 4 gezielte Sehneneinheiten pro Woche plausibel. 
In der Praxis bedeutet das häufig Intensitäten ab etwa 70 % 1RM oder, bei isometrischer Arbeit, 
...
Bei gereizter Sehne eignen sich zuerst ruhige, gut kontrollierbare Übungen: 
isometrisches Halten, langsames Wadenheben oder festes Drücken ohne Bewegung. 
Das Ziel ist nicht sofort maximale Anpassung, sondern eine Belastung zu finden, 
die regelmäßig toleriert wird.

Hilfreich ist dabei eine grobe Unterscheidung der Belastungsbereiche:
...
Das Alfredson-Protokoll ist dafür ein klassisches Beispiel im moderaten bis schweren Bereich: 
...
isometrische Plantarflexion bei etwa 90 % der Maximalkraft, 5 Sätze mit 4 Wiederholungen, 
jeweils 3 Sekunden halten und 3 Sekunden entlasten, 4-mal pro Woche über 12 Wochen. 
Dieses Protokoll führte zu Verbesserungen von Sehnensteifigkeit und Querschnittsfläche [[3]](https://doi.org/10.1186/s40798-022-00545-5).

Praktisch heißt das: Alfredson-orientiertes Training kann ein sinnvoller Einstieg oder mittlerer 
Belastungsblock sein. Für maximale mechanische Anpassung reicht „ein bisschen Wadenheben“ aber 
oft nicht aus. Dafür braucht es später höhere, kontrollierte Lasten im Bereich von etwa 60-90 % 
der maximalen Kraft.
...
| Alfredson-orientierte Fersenabsenkung | wenn langsame Exzentrik toleriert wird; zunächst ohne Zusatzgewicht |
| Berlin-Protokoll / High-Load-Isometrie | späterer Aufbau; hohe Last, kurze Haltezeit, klare Progression |

Eine wichtige Kontrolle ist der nächste Morgen. Wenn die Sehne morgens deutlich 
steifer, druckempfindlicher oder beim Einlaufen schlechter ist, war die letzte 
Belastung wahrscheinlich zu viel. Wenn sie gleich bleibt oder ruhiger wird, war 
die Dosis eher passend. Das Training muss nicht komplett schmerzfrei sein, aber 
es sollte die Beschwerden nicht steigern [[14]](https://doi.org/10.2519/jospt.2024.0302) [[15]](https://doi.org/10.2519/jospt.2015.5885).
