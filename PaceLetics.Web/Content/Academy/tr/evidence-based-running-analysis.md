...
title: "Kanıta dayalı çalışma analizi"
summary: "Analizi yürütmek neden kanıta, bağlama ve ortak kararlara ihtiyaç duyar?"
...
- Gelecekteki yaralanmalar için pozitif maliyet-etkinlik oranını gösteren orta ila iyi kanıtlar. [[1]](https://pubmed.ncbi.nlm.nih.gov/31028658/) [[2]](https://pubmed.ncbi.nlm.nih.gov/35247202/)
- Düşük ila orta düzeyde kanıt ve müdahaleyle ilişkili semptomların eş zamanlı varlığı. [[6]](https://pmc.ncbi.nlm.nih.gov/articles/PMC9655004/)

Bu gereksinimler, iyi koşu tekniğine ilişkin ortak kriterlerin çoğu için karşılanmamaktadır.
...
- Koşu stilinin göstergesi, doğru veya yanlış koşup koşmadığınızın değerlendirilmesi değildir.
- Kendi algınız önemli: Ne hissediyorsunuz, ne zaman oluyor, ne değişiyor?
- Koşu stiline her zaman rahatsızlık, antrenman, ayakkabı, tempo, hacim ve yorgunluk bağlamında bakıyoruz.
- Bir sınıflandırma ve olası seçenekler alırsınız, formu düzeltme zorunluluğunuz yoktur.

## Bir model alakalı hale geldiğinde

- Görünür bir sapma tek başına sorun değildir. Birçok koşu stili çok iyi çalışıyor.
- Kanıt iyi olduğunda ve koşarken dinamik olarak görünür hale geldiğinde bir model daha önemli hale gelir. [[1]](https://pubmed.ncbi.nlm.nih.gov/31028658/) [[2]](https://pubmed.ncbi.nlm.nih.gov/35247202/)
- Orta veya zayıf kanıtlarla en önemli şey ilgili şikayetlerin, yorgunluğun veya kontrol kaybının olup olmadığıdır. [[6]](https://pmc.ncbi.nlm.nih.gov/articles/PMC9655004/)
- Şikayetler veya makul stres eşleşmesi olmadan, çarpıcı bir model genellikle bireysel varyasyon olarak kalır.

## Yaralanmaların önlenmesine yönelik kanıt düzeyleri ve faydaları

| özellik | kanıt | Gol | Kullanmak | İlgili ise |
|---|---:|---:|---|---|
| Kalça düşüşü | B | 8 | Yüksek | Dinamik olarak görünür ve semptomlarla bağlantılı |
| Bacak iç rotasyonu | B | 8 | Yüksek | Dinamik olarak görünür ve semptomlarla bağlantılı |
| Aşırı adım | C | 7 | Orta | Aşırı yük, frenleme etkisi veya şikayetlerle birlikte |
| Ön eğim | C | 5 | Düşük | Şikayetler veya performans hedefleriyle açıkça bağlantılı |
| Kalça uzatması | D | 4 | Düşük | Yalnızca hareketlilik, güç ve semptomlar bağlamında |
| Lordoz | D | 3 | Çok düşük | Yalnızca şikayetle açık bir bağlantı varsa |
| Gövde dönüşü | D | 3 | Çok düşük | Yalnızca şikayetle açık bir bağlantı varsa |
| Kol açısı | D | 1 | HAYIR | Yaralanma riskinden ziyade çoğunlukla ritim, ekonomi veya gerilim |
