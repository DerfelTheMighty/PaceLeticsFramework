...
title: "Evidensbaseret løbeanalyse"
summary: "Hvorfor kørsel af analyse kræver beviser, kontekst og fælles beslutninger."
...
- Moderat til god evidens, der viser et positivt omkostningseffektivitetsforhold for fremtidige skader. [[1]](https://pubmed.ncbi.nlm.nih.gov/31028658/) [[2]](https://pubmed.ncbi.nlm.nih.gov/35247202/)
- Lav til moderat evidens og den samtidige tilstedeværelse af symptomer forbundet med interventionen. [[6]](https://pmc.ncbi.nlm.nih.gov/articles/PMC9655004/)

Disse krav er ikke opfyldt for de fleste af de gængse kriterier for god løbeteknik.
...
- En angivelse af løbestil er ikke en vurdering af, om du løber rigtigt eller forkert.
- Din egen opfattelse er vigtig: Hvad føler du, hvornår opstår det, hvad ændrer det?
- Vi ser altid på løbestil i sammenhæng med ubehag, træning, fodtøj, tempo, volumen og træthed.
- Du får en klassificering og mulige muligheder, ingen forpligtelse til at rette formularen.

## Når et mønster bliver relevant

- En synlig afvigelse alene er ikke et problem. Mange løbestile fungerer meget godt.
- Et mønster bliver vigtigere, når beviserne er gode, og det bliver dynamisk synligt under løb. [[1]](https://pubmed.ncbi.nlm.nih.gov/31028658/) [[2]](https://pubmed.ncbi.nlm.nih.gov/35247202/)
- Med medium eller svag evidens er det vigtigste, om der er associerede klager, træthed eller tab af kontrol. [[6]](https://pmc.ncbi.nlm.nih.gov/articles/PMC9655004/)
- Uden klager eller plausibel stresskobling forbliver et slående mønster normalt individuel variation.

## Niveauer af evidens og fordele til forebyggelse af skader

| funktion | bevis | score | At bruge | Relevant hvis |
|---|---:|---:|---|---|
| Hip drop | B | 8 | Høj | Dynamisk synlig og knyttet til symptomer |
| Indvendig rotation af ben | B | 8 | Høj | Dynamisk synlig og knyttet til symptomer |
| Overskrid | C | 7 | Medium | Sammen med overbelastning, bremseimpuls eller klager |
| Pre-tilt | C | 5 | Lav | Tydeligt knyttet til klager eller præstationsmål |
| Hofteforlængelse | D | 4 | Lav | Kun i sammenhæng med mobilitet, styrke og symptomer |
| Lordose | D | 3 | Meget lav | Kun hvis der er et klart link til klagen |
| Trunk rotation | D | 3 | Meget lav | Kun hvis der er et klart link til klagen |
| Arm vinkel | D | 1 | Ingen | For det meste rytme, økonomi eller spænding frem for risiko for skader |
