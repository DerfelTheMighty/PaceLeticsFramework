    ...
    private static MudTheme CreatePaceLeticsTheme()
    {
        return CreateTheme(
            dark: new PaletteDark
            {
                ...
                Error = "#FF4F8B",
                Background = "#120326",
                BackgroundGray = "#20073D",
                Surface = "#2B1747",
                AppbarBackground = "#1E0535",
                AppbarText = "#FFF3FF",
                DrawerBackground = "#1B0530",
                DrawerText = "#F8DDFF",
                TextPrimary = "#FFF5FF",
    ...
    private static MudTheme CreateOceanTheme()
    {
        return CreateTheme(
            dark: new PaletteDark
            {
                ...
                Error = "#FF7F76",
                Background = "#0D2742",
                BackgroundGray = "#123653",
                Surface = "#183C5F",
                AppbarBackground = "#092038",
                AppbarText = "#EAF8FF",
                DrawerBackground = "#102C49",
                DrawerText = "#D9F0FA",
                TextPrimary = "#EDF8FF",
    ...
    private static MudTheme CreateForestTheme()
    {
        return CreateTheme(
            dark: new PaletteDark
            {
                ...
                Error = "#FF8494",
                Background = "#2A1B0F",
                BackgroundGray = "#352416",
                Surface = "#3E2A19",
                AppbarBackground = "#211308",
                AppbarText = "#F5EFE5",
                DrawerBackground = "#2F1E10",
                DrawerText = "#EFE2D0",
                TextPrimary = "#F7EFE5",
    ...
    private static MudTheme CreateDarkRomanceTheme()
    {
        return CreateTheme(
            dark: new PaletteDark
            {
                ...
                Error = "#FF8CAB",
                Background = "#301923",
                BackgroundGray = "#3A202C",
                Surface = "#432738",
                AppbarBackground = "#6A2D45",
                AppbarText = "#FFEAF0",
                DrawerBackground = "#351B28",
                DrawerText = "#F8DDE8",
                TextPrimary = "#FFF2F6",
